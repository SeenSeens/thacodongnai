<?php
class Wg_Footer_Col_3 extends WP_Widget {
    public function __construct() {
      parent::__construct( '', esc_html( ' * Chính sách', 'thacodongnai' ),
           [
                'classname' => 'footer__wrap-policy', 
                'description' => esc_html( 'Chính sách', 'thacodongnai' ),
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'nav_menu' ) ); ?>"><?php esc_attr_e( ' Select Menu ', 'thacodongnai' ); ?></label> 
...
add_action( 'widgets_init', function() {
    register_widget( 'Wg_Footer_Col_3' );
});
$wg_footer_col_3 = new Wg_Footer_Col_3();
